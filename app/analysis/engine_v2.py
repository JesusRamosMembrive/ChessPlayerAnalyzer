...
# Importar modelos V2
from app.models_v2 import Game, AnalysisResult, Player
        ...
        with chess.engine.SimpleEngine.popen_uci(self.stockfish_path) as engine_sf:
            ...
            for i, move in enumerate(game.mainline_moves()):
                ...
                try:
                    ...
                    logger.warning(f"Failed to analyze position before move {move_number}")
                ...
                try:
                    ...
                    logger.warning(f"Failed to get best moves for move {move_number}")
                ...
                try:
                    ...
                    logger.warning(f"Failed to analyze position after move {move_number}")
                ...
                phase = self._determine_phase(board, move_number)
