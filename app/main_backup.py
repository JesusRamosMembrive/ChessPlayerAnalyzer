...
# Include the legacy router (old approach)
app.include_router(legacy_router)

# ────────────────────────────────────────────────────────────────────────────
# Additional legacy endpoints - imported from separate module for better organization
# ────────────────────────────────────────────────────────────────────────────

from app.api.legacy_endpoints import legacy_router as additional_legacy_router
app.include_router(additional_legacy_router, tags=["legacy-additional"])

# Games endpoints moved to legacy_endpoints.py

# ============================================================
# LEGACY ENDPOINTS MOVED TO SEPARATE MODULE
# All player, game, and task endpoints are now in app.api.legacy_endpoints
# ============================================================

# Legacy endpoints are included via router above - no duplicate endpoints needed here
