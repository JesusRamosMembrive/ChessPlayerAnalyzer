...
def _analyze_game_detailed_impl(game_id: int, username: str):
    ...
    suspicious_endgame  = (e.get("endgame_score") or 0) > 50
    ...
    # Segunda verificación de cancelación antes de commit
    cancellation_key = f"cancel:{username}"
    if redis_client.get(cancellation_key):
    ...
    # Actualizar progreso jugador y notificar
    try:
