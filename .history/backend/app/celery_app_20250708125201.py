...
from app.apm import init_sentry_celery, set_tag, add_breadcrumb, capture_exception

logger = logging.getLogger(__name__)

# Inicializar Sentry APM para Celery
init_sentry_celery()
...
def analyze_player_detailed(_, username: str):
    ...
    """
    # APM: Establecer contexto de la tarea
    set_tag("task.type", "player_analysis")
    set_tag("player.username", username)
    add_breadcrumb(
        message=f"Iniciando análisis detallado del jugador {username}",
