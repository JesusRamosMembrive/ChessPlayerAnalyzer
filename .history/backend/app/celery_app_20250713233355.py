...
def export_analysis_to_json(data_obj, username: str, analysis_type: str = "analysis"):
    ...
    """
    pass # This function is now imported directly
...
def analyze_player_detailed(_, username: str):
    ...
    try:
        ...
        with Session(engine) as s:
           ...
           # export_analysis_to_json(pa, username, "player") # This line is now handled by the decorator
...
from app.tasks.utils import safe
...
def analyze_game_detailed(game_id: int, username: str) -> dict[str, int | str | bool]:
    ...
    with Session(engine) as s:
        ...
        # export_analysis_to_json(detailed, username, "game") # This line is now handled by the decorator
